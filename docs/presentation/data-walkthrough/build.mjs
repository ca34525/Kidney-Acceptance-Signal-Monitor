...
const inputs = ['configs/data_sources.yaml', 'configs/patient_journey_v2/methodology.yaml', 'SPEC.md', 'docs/specs/patient-journey-v2.md', 'docs/model_card.md', 'docs/acceptance_forecast_results.md', 'docs/decisions/0016-retire-bias-gate-and-correct-readiness.md', 'docs/audits/source-definition-0029.md', 'docs/audits/source-feasibility-0022.md', 'docs/deceased_donor_receipt_results.md', 'docs/waiting_list_case_study.md', 'docs/patient_journey_v2_followup_results.md', 'docs/patient_journey_v2_component_results.md', 'docs/presentation/v2-followup/program-case.md', 'src/kasm/data/parse.py', 'src/kasm/data/cache.py', 'docs/presentation/v2-followup/interview.pptx', 'docs/presentation/data-walkthrough/slides.json', 'docs/presentation/data-walkthrough/build.mjs', 'uv.lock'];
